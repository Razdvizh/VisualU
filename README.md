# VisualU
Plugin for Unreal Engine 5.5 that brings core functionality for a widget-based visual novel narrative.

# Setup
Build the plugin for the Unreal Engine 5.5.x project
